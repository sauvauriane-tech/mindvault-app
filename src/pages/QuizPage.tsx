    ...
    return (
      <div className="min-h-screen bg-background pb-20">
        ...
        <div className="pt-14 max-w-md mx-auto px-4 py-16 text-center">
          ...
          <Trophy className={cn("w-12 h-12 mx-auto mb-4", perfect ? "text-secondary" : "text-muted-foreground")} />
          <h1 className="text-3xl font-bold mb-2">{score}%</h1>
          <p className="text-muted-foreground mb-2">
            {answers.filter(Boolean).length} / {questions.length} correct
          </p>
          <p className="text-lg font-medium mb-8">
            {perfect ? 'Perfect score! Brilliant!' : score >= 70 ? 'Great work!' : 'Keep studying!'}
          </p>
      ...
      <div className="pt-14 max-w-xl mx-auto px-4 py-8">
        ...
        {showResult && (
          <div className={cn(
            ...
            selected === q.correctIndex ? "bg-primary/10 text-primary border border-primary/20" : "bg-destructive/10 text-destructive border border-destructive/20"
          )}>
